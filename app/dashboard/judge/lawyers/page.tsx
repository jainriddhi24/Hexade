...
export default function JudgeLawyersPage() {
  const { user } = useAuth()
  const [searchTerm, setSearchTerm] = React.useState('')
  const [selectedSpecialty, setSelectedSpecialty] = React.useState('all')
  const [viewMode, setViewMode] = React.useState('manage') // 'manage' or 'view'
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-gray-600">Manage and monitor lawyers in your court system</p>
            </div>
        ...
        <div className="mb-8">
          ...
          <div className="flex items-center justify-between">
            <p className="text-gray-600">
              Showing {filteredLawyers.length} lawyers in your court system
            </p>
            <Button variant="outline" className="flex items-center">
              ...
              <CardContent>
                <div className="space-y-3">
                  ...
                  <div className="flex items-center text-sm text-gray-600">
                    ...
                    {lawyer.cases} total cases
                  </div>
                  
                  <div className="flex items-center text-sm text-gray-600">
                    <Scale className="h-4 w-4 mr-2" />
                    {lawyer.courtAppearances} court appearances
                  </div>
        ...
        <div className="mt-12">
          <Card>
            <CardHeader>
              <CardTitle>Court System Statistics</CardTitle>
              <CardDescription>Overview of lawyers in your court system</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                ...
                <div className="text-center">
                  <div className="text-3xl font-bold text-purple-600">
                    {lawyers.reduce((sum, l) => sum + l.assignedCases, 0)}
                  </div>
                  <div className="text-sm text-gray-600">Total Assigned Cases</div>
                </div>
                <div className="text-center">
